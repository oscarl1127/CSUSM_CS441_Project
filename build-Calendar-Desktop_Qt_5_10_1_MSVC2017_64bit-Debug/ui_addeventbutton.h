...
public:
    ...
    void setupUi(QDialog *AddEventButton)
    {
        ...
        groupBox = new QGroupBox(AddEventButton);
        groupBox->setObjectName(QStringLiteral("groupBox"));
        groupBox->setGeometry(QRect(10, 110, 431, 201));
        groupBox->setCheckable(true);
        groupBox->setChecked(false);
        label_12 = new QLabel(groupBox);
        label_12->setObjectName(QStringLiteral("label_12"));
        label_12->setGeometry(QRect(120, 170, 191, 16));
        Zip_Box = new QTextEdit(groupBox);
        ...
        Stste_Box = new QTextEdit(groupBox);
        ...
        City_Box = new QTextEdit(groupBox);
        ...
        Street_Box = new QTextEdit(groupBox);
        ...
        Location_Box = new QTextEdit(groupBox);
    ...
    void retranslateUi(QDialog *AddEventButton)
    {
        ...
        groupBox->setTitle(QApplication::translate("AddEventButton", "Location", nullptr));
