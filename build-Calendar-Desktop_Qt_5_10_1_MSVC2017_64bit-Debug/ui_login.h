...
"color: qlineargradient(spread:reflect, x1:0, y1:1, x2:0.985222, y2:1, stop:1 rgba(153, 153, 153, 255));"));
        ...
        username_lineEdit->setGeometry(QRect(330, 313, 131, 21));
        ...
        Title->setGeometry(QRect(200, 180, 411, 97));
        Title->setMaximumSize(QSize(411, 100));
        QFont font1;
...
""));
        ...
        pushButton_2->setGeometry(QRect(270, 260, 271, 31));
        QFont font3;
...
""));
        ...
        pushButton_3->setGeometry(QRect(0, 260, 281, 31));
