...
QT_MOC_LITERAL(1, 8, 24), // "on_TimeTable_cellClicked"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 3), // "row"
QT_MOC_LITERAL(4, 38, 6), // "column"
QT_MOC_LITERAL(5, 45, 30) // "on_TimeTable_cellDoubleClicked"

    },
    "DayView\0on_TimeTable_cellClicked\0\0row\0"
    "column\0on_TimeTable_cellDoubleClicked"
};
...
void DayView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DayView *_t = static_cast<DayView *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_TimeTable_cellClicked((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->on_TimeTable_cellDoubleClicked((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
