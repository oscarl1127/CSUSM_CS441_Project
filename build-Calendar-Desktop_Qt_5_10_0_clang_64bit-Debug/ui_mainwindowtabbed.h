...
public:
    ...
    QDateEdit *AddEvent_FromDateSelector;
    QLabel *AddEvent_CategoryLabel;
    QComboBox *AddEvent_CategorySelector;
    QTimeEdit *AddEvent_ToTimeSelector;
    QLabel *AddEvent_CityLabel;
    QTextEdit *AddEvent_NoteTextSection;
    QLabel *AddEvent_NotifyMeLabelPt2;
    QTimeEdit *AddEvent_FromTimeSelector;
    ...
    QTextEdit *AddEvent_StateTextSection;
    QTextEdit *AddEvent_StreetNameTextSection;
    QLabel *AddEvent_Title;
    QLabel *AddEvent_TitleLabel;
    QCheckBox *AddEvent_TravelTimeNotification;
    QTextEdit *AddEvent_LocationNameTextSection;
    QLabel *AddEvent_LocationNameLabel;
    QLabel *AddEvent_NotifyMeLabelPt1;
    QTextEdit *AddEvent_TitleTextSection;
    QTextEdit *AddEvent_ZipCodeTextSection;
    QLabel *AddEvent_ZipCodeLabel;
    QDateEdit *AddEvent_ToDateSelector;
    QTextEdit *AddEvent_CityTextSection;
    ...
    void setupUi(QDialog *mainWindowTabbed)
    {
        ...
        AddEvent_FromDateSelector = new QDateEdit(AddEventTab);
        AddEvent_FromDateSelector->setObjectName(QStringLiteral("AddEvent_FromDateSelector"));
        AddEvent_FromDateSelector->setGeometry(QRect(50, 73, 81, 24));
        ...
        AddEvent_CategorySelector = new QComboBox(AddEventTab);
        AddEvent_CategorySelector->setObjectName(QStringLiteral("AddEvent_CategorySelector"));
        AddEvent_CategorySelector->setGeometry(QRect(400, 30, 221, 26));
        AddEvent_ToTimeSelector = new QTimeEdit(AddEventTab);
        AddEvent_ToTimeSelector->setObjectName(QStringLiteral("AddEvent_ToTimeSelector"));
        AddEvent_ToTimeSelector->setGeometry(QRect(140, 100, 91, 24));
        ...
        AddEvent_NoteTextSection = new QTextEdit(AddEventTab);
        AddEvent_NoteTextSection->setObjectName(QStringLiteral("AddEvent_NoteTextSection"));
        AddEvent_NoteTextSection->setGeometry(QRect(340, 60, 281, 91));
        ...
        AddEvent_FromTimeSelector = new QTimeEdit(AddEventTab);
        AddEvent_FromTimeSelector->setObjectName(QStringLiteral("AddEvent_FromTimeSelector"));
        AddEvent_FromTimeSelector->setGeometry(QRect(140, 73, 91, 24));
        ...
        AddEvent_StateTextSection = new QTextEdit(AddEventTab);
        AddEvent_StateTextSection->setObjectName(QStringLiteral("AddEvent_StateTextSection"));
        AddEvent_StateTextSection->setGeometry(QRect(130, 350, 81, 21));
        AddEvent_StreetNameTextSection = new QTextEdit(AddEventTab);
        AddEvent_StreetNameTextSection->setObjectName(QStringLiteral("AddEvent_StreetNameTextSection"));
        AddEvent_StreetNameTextSection->setGeometry(QRect(0, 300, 321, 21));
        ...
        AddEvent_LocationNameTextSection = new QTextEdit(AddEventTab);
        AddEvent_LocationNameTextSection->setObjectName(QStringLiteral("AddEvent_LocationNameTextSection"));
        AddEvent_LocationNameTextSection->setGeometry(QRect(0, 250, 321, 21));
        ...
        AddEvent_TitleTextSection = new QTextEdit(AddEventTab);
        AddEvent_TitleTextSection->setObjectName(QStringLiteral("AddEvent_TitleTextSection"));
        AddEvent_TitleTextSection->setGeometry(QRect(50, 30, 271, 21));
        AddEvent_ZipCodeTextSection = new QTextEdit(AddEventTab);
        AddEvent_ZipCodeTextSection->setObjectName(QStringLiteral("AddEvent_ZipCodeTextSection"));
        AddEvent_ZipCodeTextSection->setGeometry(QRect(240, 350, 81, 21));
        ...
        AddEvent_ToDateSelector = new QDateEdit(AddEventTab);
        AddEvent_ToDateSelector->setObjectName(QStringLiteral("AddEvent_ToDateSelector"));
        AddEvent_ToDateSelector->setGeometry(QRect(50, 100, 81, 24));
        AddEvent_CityTextSection = new QTextEdit(AddEventTab);
        AddEvent_CityTextSection->setObjectName(QStringLiteral("AddEvent_CityTextSection"));
        AddEvent_CityTextSection->setGeometry(QRect(0, 350, 101, 21));
